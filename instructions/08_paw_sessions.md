    ...
    <html>
      <head>
        ...
        var _TSUGI = {
            ...
            rest_path: {"parent":"\/assn","base_url":"https:\/\/www.dj4e.com","controller":"paw_sessions.md","extra":"","action":false,"parameters":[],"current":"\/assn\/paw_sessions.md","full":"\/assn\/paw_sessions.md"},
...
<select id="chapters" onchange="onSelect();">
  ...
  <option value="paw_sessions.md" selected>Django Sessions</option>
...
<p>In this assignment we will add  a few lines of code to demonstrate sessions.</p>
<p><a href="https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Sessions">https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django/Sessions</a></p>
<p>The sessions tutorial is simple enough that it needs no further explanation.</p>
<p>Make sure to reload your application under the <code>Web</code> tab in
<a href="https://www.pythonanywhere.com" target="_blank">PythonAnywhere</a> whenever you change the <code>views.py</code> file.</p>
<h2>References</h2>
